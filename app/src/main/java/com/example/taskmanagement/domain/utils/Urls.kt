...
import com.example.taskmanagement.domain.data_models.TaskPriority
...
object Urls {
    ...
    fun getTaskCommentUrl(taskId: String, commentId: String) = "$BASE_URL/tasks/$taskId/comments/$commentId"
